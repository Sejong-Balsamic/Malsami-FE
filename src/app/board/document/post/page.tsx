...
// import SubjectSearchInputComponent from "@/deprecated/questionPost/SubjectSearchInputComponent";
...
// TODO: 아직 문서 작성 페이지가 완성되지 않았습니다. 임시로 빈 컴포넌트를 노출해 빌드 오류를 방지합니다.

export default function DocPostPagePlaceholder() {
  return null; // 추후 실제 구현으로 교체
}
