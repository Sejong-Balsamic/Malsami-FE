  ...
  return (
    <div className="mt-[20px] flex flex-col gap-[20px]">
      <div className="relative grid w-full grid-cols-3 grid-rows-1 rounded-[10px] border-2 border-[#95e4da] py-[24px]">
        <button type="button" className="flex flex-col items-center justify-center gap-[12px]">
        ...
        <button type="button" className="flex flex-col items-center justify-center gap-3">
          <div className="flex items-center gap-2">
