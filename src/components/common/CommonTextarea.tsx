...
export default function CommonTextarea({
  ...
  return (
    <textarea
      ...
      maxLength={maxLength}
      required={required}
      className={`font-suit-medium w-full rounded-lg border-2 border-ui-border px-4 py-[18px] text-SUIT_14 placeholder-ui-muted transition-colors focus:outline-none ${focusBorderClass} ${className}`}
    />
  );
}
