  ...
  return (
    <div>
      <h2 className="font-suit-medium mb-3 text-base">
        기본 태그 <span className="font-suit-medium ml-1.5 text-SUIT_14 text-ui-muted">최대 2개</span>
      </h2>
      ...
      <div className="flex flex-wrap gap-x-3 gap-y-2">
        {Object.entries(documentTypeLabels).map(([key, label]) => (
          <button
            ...
            className={`font-suit-medium rounded-full border-[1px] px-3 py-2 text-SUIT_16 transition-colors ${
