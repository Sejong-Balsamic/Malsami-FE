    ...
    <div>
      ...
      <div className="relative mb-3">
        <input
          ...
          maxLength={10}
          className="font-suit-medium w-full rounded-lg border-2 border-ui-divider px-4 py-[18px] text-SUIT_14 placeholder-gray-400 transition-colors focus:border-document-main focus:outline-none"
        />
