  ...
  return (
    <div>
      ...
      <QuestionCommonInput
        ...
        className="font-suit-medium w-full rounded-lg border-2 border-ui-border px-4 py-[18px] text-base placeholder-gray-400 focus:border-document-main focus:outline-none"
      />
    </div>
  );
}
