      ...
      <div className="flex items-center gap-1.5">
        ...
        <div className="relative inline-flex items-center">
          <select
            ...
            className="font-suit-medium peer appearance-none rounded-lg border-2 border-ui-divider bg-transparent px-6 py-[14px] pr-10 text-[14px] text-black transition-colors focus:border-document-main focus:outline-none"
          >
            {docStudyYears.map(y => (
