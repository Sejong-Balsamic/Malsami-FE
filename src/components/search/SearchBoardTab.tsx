      ...
      <div className="flex justify-between">
        ...
        >
          ...
          <span className="absolute bottom-0 left-0 h-1 w-full">
            {/* 회색 2px 기준선 (항상 표시) */}
            <span className="absolute left-0 top-1/2 h-0.5 w-full -translate-y-1/2 transform rounded bg-ui-border" />
            {/* 활성 탭 컬러 4px 바 */}
            {activeTab === "자료게시판" && (
              <span className="absolute bottom-0 left-0 h-1 w-full rounded bg-document-main" />
            )}
          </span>
        </button>
        {/* 질문게시판 탭 */}
        ...
        >
          ...
          <span className="absolute bottom-0 left-0 h-1 w-full">
            ...
            {/* 활성 탭 컬러 4px 바 */}
            {activeTab === "질문게시판" && (
              <span className="absolute bottom-0 left-0 h-1 w-full rounded bg-question-main" />
            )}
          </span>
        </button>
      </div>
