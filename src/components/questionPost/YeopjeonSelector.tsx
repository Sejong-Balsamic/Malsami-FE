    ...
    <div>
      ...
      <div className="mb-8 flex items-center justify-center gap-4">
        ...
        <input
          ...
          className={`h-[50px] w-[106px] rounded-lg border-2 border-ui-border px-4 text-center text-sm font-semibold focus:border-question-main focus:outline-none ${isZero ? "text-gray-400" : "text-black"}`}
        />
