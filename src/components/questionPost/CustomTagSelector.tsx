...
function CustomTagSelector({ tags, onTagsSubmit, onRemoveTag }: CustomTagSelectorProps) {
  ...
  return (
    <div>
      ...
      <h3 className="font-suit-medium mb-3 text-SUIT_14 text-tag-custom-text">
      ...
      <div className="relative mb-3">
        <input
          ...
          maxLength={10}
          className="font-suit-medium w-full rounded-lg border-2 border-ui-divider px-4 py-[18px] text-SUIT_14 placeholder-gray-400 transition-colors focus:border-question-main focus:outline-none"
        />
        ...
        <div className="flex flex-wrap gap-2">
          {tags.map(tag => (
            <div
              ...
              className="font-suit-bold flex cursor-pointer items-center rounded-full border-[1px] border-question-main bg-white px-3 py-2 text-[16px] text-question-main hover:bg-gray-50"
              role="button"
              tabIndex={0}
              onKeyDown={e => {
